...
/**
 * Twitter card image — misma base visual que la OG image.
 * (summary_large_image exige 1200×630.)
 */
/**
 * Carga una fuente de Google Fonts parseando el CSS (ver opengraph-image.tsx).
 */
